...
```{r}
states <- read_sf("~/GitHub/MTH_190_Intro_to_DS/course-materials/cb_2021_us_state_500k") |>
  sf::st_transform('+proj=longlat +datum=WGS84')

counties <- read_sf("~/GitHub/MTH_190_Intro_to_DS/course-materials/cb_2021_us_county_5m") |>
