...
The lecture schedule and associated readings can be found on the [main page](../index.html) of this course webpage. The Modern Data Science with R *textbook* is accessible on the navigational bar of this webpage as well as via [this link](https://mdsr-book.github.io/mdsr2e/).
